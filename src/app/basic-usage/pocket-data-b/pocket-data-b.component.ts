...
@Component( {
  selector: 'lpd-pocket-data-b',
  templateUrl: './pocket-data-b.component.html',
  styleUrls: [ './pocket-data-b.component.scss' ]
} )
export class PocketDataBComponent implements OnInit, OnDestroy {
  ...
  constructor( private pocket: PocketService ) {
    ...
    this.tForm.valueChanges.subscribe( v => {
      ...
      }, { receiver: POCKET_GLOBAL_DATA_CONTAINER_B_RECEIVER }, true )
    } );
